...
def upload_loacation(instance,filename):
	file_path = 'blog/{auther_id}/{title}.{filename}'.format(
			auther_id = str(instance.auther.id),
...
class BlogPost(models.Model):
	...
	image					= models.ImageField(upload_to=upload_loacation, null=False, blank=False)
